...
public class PTTru extends AppCompatActivity {
    EditText soA, soB;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnQuayLai.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder exit = new AlertDialog.Builder(PTTru.this);
                ...
                exit.setNegativeButton("Thoát", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        Intent mainScreen = new Intent(PTTru.this, MainActivity.class);
    ...
    void CheckDapAn(int luaChon) {
        AlertDialog.Builder mydialog = new AlertDialog.Builder(PTTru.this);
